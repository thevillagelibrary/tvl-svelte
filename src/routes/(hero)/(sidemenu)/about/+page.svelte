...
<PageBody>
	<p>
		In 1990 a small but visionary group of people on Skidaway Island conceived the idea of a
	...
	<p>
		Unlike tax supported public libraries, we receive no funds from Federal, State or local
	...
	<p>
		The Library is open Tuesday through Saturday from 10:00 a.m. to 5:00 p.m. We are closed on
		Sunday and Monday, and on the following holidays: Memorial Day, Fourth of July, Labor Day,
		Thanksgiving (and the afternoon before), December 24-26, and New Years Eve and Day.
	</p>
	<p>
		The library is run by about ninety volunteers who each donate from 25 to more than 100 hours of
