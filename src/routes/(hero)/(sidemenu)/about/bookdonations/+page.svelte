...
<PageBody>
	<ul>
		<li>Small Donations (individual or one small bag or box): Tues. - Sat., 10 a.m. to 5 p.m.</li>
		<li>Large Donations: Sat., 10 a.m. to 12</li>
		<li>Estate Donations: By appointment (call the Library)</li>
	</ul>
	<p>
		The Village Library accepts donations of current hardback and paperback books, children’s books,
		...
		for more specific information regarding all donated items.
	</p>
	<p>
		The Village Library is most interested in the following types of materials for inclusion in its
		Book Sale inventory. Our books are available for sale during regular hours of operation, Monthly
		Bag of Book Sales, and our annual Fall and Spring Book Sales:
	</p>
	<dl>
	...
	<p>
		The following are books and periodicals that we cannot use or even accept as they present a
		disposal problem:
	</p>
	<dl>
		<dt>Damaged books, which may include:</dt>
		<dd>
			Missing book jackets, covers, or pages; loose bindings; ripped or missing pages;
		...
		<dd>Encyclopedias, Dictionaries, Bibliographies, Almanacs, Directories, Atlases, Handbooks</dd>
	...
	<p>
		<b> The Village Library acknowledges the great importance of your donation. </b>
	</p>
	<p>
		<b>Thank you.</b>
	</p>
