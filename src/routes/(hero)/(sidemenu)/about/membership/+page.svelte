...
<PageBody>
	<p>
		Membership in The Village Library is open to anyone. It will cost only $20 for a family to join.
		...
		be a member to purchase any of our thousands of used books.
	</p>
	<p>
		We have a special rate for our latest bestselling books, DVDs and Audio Books. We put the latest
		...
		Courses&quot; CDs and DVDs can be checked out the sane as books, free for three weeks.
	</p>
	<p>
		We have no paid employees. The library is managed and staffed by volunteers. Volunteers are
		...
		enter data into a computer. Almost anyone who can create email can learn our system.
	</p>
</PageBody>
